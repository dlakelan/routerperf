...
ipt46dscp -p udp -m DSCP --dscp-class CS7 -m hashlimit --hashlimit-mode srcip,srcport,dstip,dstport --hashlimit-above 150/second --hashlimit-rate-interval 1 -j DSCP --set-dscp-class CS2
